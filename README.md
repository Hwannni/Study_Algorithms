...
* 👨🏽‍💻 minchur : BFS문제도 오랜만에 풀어봐서 좋았던거같다.
...
### 2024_07_07 Day13
* 🧑🏻‍💻 minan : 그리디 문제는 제대로 이해하지 못한거 같다. 그리디에 대한 학습을 추가로 더 해야 프로그래머스의 의도대로 풀 수 있을거 같다.
* 👨🏽‍💻 minchur : 일정상 불참

### 2024_07_08 Day14
* 🧑🏻‍💻 minan : 레벨3... 처참히 밟혔다. 다시 자료구조, 간단한 알고리즘 문제부터 해서 복습할 필요가 있을거 같다.
* 👨🏽‍💻 minchur : 오늘 내가 틀렸던 부분에대해서는 인지는 하였으나 그곳에대한 고민을 하다가 시간이 끝났었다. 아쉽지만 복습으로 어떻게 틀렸던 부분을 보완할수있을지 확인해봐야겠다.

### 2024_07_09 Day15
* 🧑🏻‍💻 minan : 배열 문제로 돌아왔다. 확실히 level2,3를 겪다가 오니 아주 문제가 선녀다.
* 👨🏽‍💻 minchur : 어제까지 다이내믹프로그래밍파트하다가 다시 배열로 들어와서 신선하고 리프레쉬한 날이였다.

### 2024_07_10 Day16
* 🧑🏻‍💻 minan : 파이썬의 함수들로 비교적 쉽게 풀 수 있었다. 딕셔너리 문제는 키-값의 관계로 풀면 된다는 생각에 쉽게 접근할 수 있었지만 만약 딕셔너리 문제라고 알려주지 않았을때 문제만 보고 딕셔너리를 파악하는 것이 실제 관건일거 같다.
* 👨🏽‍💻 minchur : 오늘 민환이형의 풀이를 보고 내 코드보다 상당히 좋았다라는 걸 느꼈다 다음 스터디때에는 나도 좀더 클린하고 좋은 코드를 짜도록 노력해야겠다.

### 2024_07_11 Day17
* 🧑🏻‍💻 minan : set에 대한 문자를 처음 접했을때 쉽게 풀수 있을거라 생각했지만, 처음 설계했던 코드에서 시간초과가 발생하여 당황했다.... 못 풀었다는게 억울해 뒤늦게라고 풀고 제출했다.
* 👨🏽‍💻 minchur : set까지는 어느정도 정리가 된 느낌이다.

### 2024_07_12 Day18
* 🧑🏻‍💻 minan : 스택의 문제들은 머릿속으로 팬케이크를 만든다 생각하면 편했는데, 마침 문제마저 햄버거(팬케이크와 비슷한) 문제가 나와 비교적 쉽게 풀었다.
* 👨🏽‍💻 minchur : 

### 2024_07_13 Day19
* 🧑🏻‍💻 minan : 문제 이해는 빠르게 되었지만, 설계에서 막혔다. 전체적인 설계는 글로 쓸 수 있었지만 코드로 구현하는 작업에서 실패했던 문제!
* 👨🏽‍💻 minchur : 오늘은 뭔가 설계를 제대로 하질 못하고 의식의 흐름따라 코드를 짰던거 같다. 문제도 어려워서 그랬지만 문제가 어려워도 어느정도의 설계는 하고 들어가야 할거 같다.

### 2024_07_14 Day20
* 🧑🏻‍💻 minan : 문제의 난이도가 올라가면서 못푸는 문제들이 많아졌다.. 특히 레벨3은 많이 힘들다. 아무래도 문제풀이 외에도 자료구조 및 알고르즘에 대한 추가 학습이 필요할거 같다.
* 👨🏽‍💻 minchur : 다행히도 아이디어대로 코드를 짰는데 정답까지 이루어졌던것같다 이러한 상황이 많이 있을거 같진 않지만 운이 좋았던거 같다.

### 2024_07_15 Day21
* 🧑🏻‍💻 minan : 설계 자체나 기본 풀이는 나쁘지 않았던거 같았다. DFS/BFS 강의 중 경로탐색을 봤기 때문에 가능했던거 같긴 하지만 도착지와 출발지가 서로 중첩될시 문제가 발생한다.
* 👨🏽‍💻 minchur : 최종 제출하였을때 절반의 문제 까지는 정답을 맞췄지만 틀렸던 부분에 대해서는 정확한 이유를 찾지는 못했던거 같다.

### 2024_07_16 Day22
* 🧑🏻‍💻 minan : 간만에 문제 풀이 성공... BFS 관련 경로 탐색 문제는 문제들마다 공통적인 부분이 크게 있는거 같다.
* 👨🏽‍💻 minchur : 최종 제출을 하였을때 3분의 1 가량만 맞췄다. 예외되는 경우가 있는거 같다..어제도 그렇고 오늘도 어느정도까지는 풀이를 했지만 완벽하게 풀어낸것 같지가 않았다. 잘 보완해서 다음에 DFS/BFS파트로 돌아오면 정답을 맞춰보겠다!! 

### 2024_07_17 Day23
* 🧑🏻‍💻 minan : 간만에 level0... 행복했다. 첫 벗째 정렬문제에서 문제를 잘못 파악해서 시간초과가 발생하긴 했다.
* 👨🏽‍💻 minchur : 오늘 정렬파트는 은근 빨리 풀었다 생각했던 아이디어가 찰떡같이 맞아서 다행이였다고 생각한다.

### 2024_07_19 Day24
* 🧑🏻‍💻 minan : set을 이용한 간단한 문제풀이였던거 같다. 제한사항에 함정이 있었던 문제였지만 잘 해결할 수 있었다.
* 👨🏽‍💻 minchur : 초반에 조금 막혔었지만 잘 해결해서 풀었던것 같다.

### 2024_07_20 Day25
* 🧑🏻‍💻 minan : 코드 에러는 없지만 효율성 문제로 통과X. 모든 경로의 수를 파악하는 BFS 만으로는 풀 수 없었다.
* 👨🏽‍💻 minchur : 전에 BFS파트 문제풀이 할때 비슷한 유형을 풀었었는데 틀린적이 있었다. 이번에는 그때 BFS문제풀이중 민환이형 아이디어를 인용해서 풀었더니 정답을 맞출수 있었던것 같다. 

### 2024_07_22 Day26
* 🧑🏻‍💻 minan : level2 였지만 생각보다 둘 다 수월하게 풀었다. stack은 주말간 복습한 것이 빛을 발한듯...
* 👨🏽‍💻 minchur : 자꾸 한부분에서 오류가 나던지 틀렸었다...그래도 시간내에 찾아서 빠르게 해결했던거 같다!

### 2024_07_23 Day27
* 🧑🏻‍💻 minan : 레벨의 문제도 있었지만 기본적 DFS에 대한 이해도가 없어서 풀기가 힘든 문제였다. 따로 DFS 공부 후 블로그에 게시해야겠다
* 👨🏽‍💻 minchur : 정답이라고 생각했던 풀이였는데 30점맞았다 어디서 실수를 했는지 확인해봐야겠다.

### 2024_07_24 Day28
* 🧑🏻‍💻 minan : 정렬 문제는 약간의 패턴이 존재하는거 같다. 보통 index()를 이용하거나, min(),  max()를 찾는 정도?
* 👨🏽‍💻 minchur : 이제 정렬파트는 어느정도 숙달이 많이 된거 같다!!

### 2024_07_25 Day29
* 🧑🏻‍💻 minan : 람다 함수 사용법을 몰라 검색했다... 기본적인 함수 사용법에 대한 공부가 필요하다. 커리큘럼 정리도 했다.
* 👨🏽‍💻 minchur : 어느 인덱스번호로 정렬을 할지가 엄청 고민 이였지만 직접확인해보고 테스트 케이스도 추가해보면서 풀었던거 같다.

### 2024_07_26 Day30
* 🧑🏻‍💻 minan : 머릿속에서 맴도는 구현 방식을 minchur이가 깔끔하게 풀어준거 같다. 30일동안 하면서 느낀 점은 level2,3 는 아직 많이 힘든 느낌이다. 알고리즘에 대한 공부 없이 풀어서 그런거 같다. 추가학습 필요!
* 👨🏽‍💻 minchur : 유일하게 생각해낸 아이디어가 잘 풀려서 다행이였던거 같다.

### 2024_07_28 Day31
* 🧑🏻‍💻 minan : 셋(집합)문제 중 마지막 문제인 "신고 결과 받기" 문제에서 어려움을 겪었다. 단순히 집합만 사용하는 것이 다른 사고방식을 더 확장할 필요가 있다.


### 2024_08_01 Day32
* 🧑🏻‍💻 minan : 정렬 문제 중 마지막 문제는 체감상 level2,3에 가까웠다. 주어진 풀이식을 이용하여 이차원배열이나 딕셔너리 형태로 가공했다면 문제풀이가 수월했을거라 생각한다.
* 👨🏽‍💻 minchur : 새로운 부트캠프가 시작되고 조금 적응하는데 시간이 있어서 오랜만에 풀었던거 같다.